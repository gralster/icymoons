...
def translation(vector,distance,direction):
    if str(direction) == "x":
        newvector = np.add(vector,np.array([[distance],[0],[0]]))
    elif str(direction) == "y":
        newvector = np.add(vector,np.array([[0],[distance],[0]]))
    elif str(direction) == "z":
        newvector = np.add(vector,np.array([[0],[0],[distance]]))
    else:
        pass
    return newvector
